...
const SocialBadge = ({ social }: { social: Social }) => {
  return (
    <Link
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.backgroundColor =
          e.currentTarget.style.getPropertyValue("--hover-bg-color");
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <ArrowRight
        className={
          "w-4 h-4 ml-2 mr-1 group-hover:translate-x-0.5 transition-transform duration-200"
        }
      />
    </Link>
  );
